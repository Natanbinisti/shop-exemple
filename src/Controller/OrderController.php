...
class OrderController extends AbstractController
{
    ...
    public function selection(AddressRepository $addressRepository, PaymentMethodRepository $paymentMethodRepository, EntityManagerInterface $entityManager, Request $request, CartService $cartService): Response
    {
    ...
    public function orderPayed(Order $order, EntityManagerInterface $entityManager, CartService $cartService): Response
    {
